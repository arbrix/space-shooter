...
class Sprite:
    ...
    def collide(self, other_object):
        ...
        return (dist(self.pos, other_pos) < (self.radius + other_object.get_radius()))
...
def rock_spawner():
    ...
    while len(rock_group) < 12:
        ...
        if dist(rock_pos, my_ship.get_position()) < (asteroid_info.get_radius() + my_ship.get_radius() + 40):
            continue
        rock_vel = [random.random() * .6 - .3 + score / 50, random.random() * .6 - .3 + score / 50]
